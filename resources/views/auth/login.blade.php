<x-layout>
  <section class="bg-cover bg-center" style="background-image: url('{{ Vite::asset('resources/assets/wavebackground.svg') }}');">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <img class="w-[200px] h-[200px] mr-2 mt-[-100px]" src="{{ Vite::asset('resources/assets/Opuswhite2.png') }}" alt="logo">
      <div class="w-full bg-white rounded-lg shadow-lg md:mt-0 sm:max-w-md xl:p-0">
        <div class="p-8 space-y-6 sm:p-10">
          ...
          <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
            ...
            <button type="submit"
              class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-md">Sign
              in</button>
          </form>
        </div>
      </div>
