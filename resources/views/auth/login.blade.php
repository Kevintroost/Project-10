...
<section class="">
  ...
  <img class="w-[200px] h-[200px] mr-2 mt-[-100px]" src="{{ Vite::asset('resources/assets/Opuswhite.png') }}" alt="logo">
    <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-neutral-800 dark:border-gray-700">
