<x-admin-layout>
  <div class="max-w-md my-7 mx-auto bg-white p-8 shadow-md rounded-md">
    ...
    <form>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="datetime-local" name="date" id="event-date" value="{{ old('date') }}"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2.5" />
        </div>
      </div>
      ...
      <div class="mt-4">
        ...
        <textarea id="description" placeholder="Add event description" rows="4"
