...
<body>
  ...
  <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
    <!-- Main Row: Newsletter + Social Media Icons -->
    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0">
      
      <!-- Newsletter Section -->
      <div class="flex flex-col space-y-2">
        <h2 class="text-lg font-semibold">Subscribe Newsletter</h2>
        <p class="text-sm text-gray-400">
          Subscribe to get 10% discount on all products.
        </p>
      </div>
      ...
      <form class="flex items-center space-x-2">
        <input
          ...
          class="px-4 py-2 w-full md:w-auto rounded-md border border-gray-600 bg-neutral-900 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500"
        />
        <button
          type="submit"
