...
<body class="flex h-screen bg-neutral-800 dark:bg-white">
   ...
   <aside id="default-sidebar"
      ...
      <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-800 dark:bg-neutral-800 flex flex-col">
         ...
         <ul class="space-y-2 font-medium">
            ...
            <li>
               <a href="{{ url('/admin/dashboard/event-request/index')}}"
                  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                     xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap">Check requests</span>
               </a>
            </li>
            <li>
               <a href="{{ url('/admin/dashboard/contact/index')}}"
                  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                     xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                     <path fill-rule="evenodd"
            ...
            <li>
               <a href="{{ url('/admin/dashboard/about-us/index')}}"
                  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                     xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                     <path
            ...
            <li>
               <a href="{{ url('/admin/dashboard/image/create') }}"
                  class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
   ...
   <div class="relative w-full h-full overflow-y-auto bg-blue-50 lg:ml-64">{{$slot}}</div>
