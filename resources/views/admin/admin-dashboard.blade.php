<x-admin-layout>
  ...
  <div class="flex gap-4 p-6">
    ...
    <div class="bg-white p-10 shadow-md rounded-md w-full max-w-2xl " style="max-width: 590px;">
      ...
      @enderror
          ...
          <div class="mt-4">
            ...
            <div class="mt-1">
              <input type="url" name="image_url" id="image-url" placeholder="Enter image URL" value="{{ old('image') }}"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 py-3 px-6 h-11" />
            </div>
          </div>
    ...
    <div class="bg-white p-10 shadow-md rounded-md w-full " style="max-width: 285px;">
      ...
      <ul class="space-y-3">
        ...
        <li class="flex items-center justify-between ">
          ...
          <a href="https://ticketmaster.nl/" class="text-blue-500 hover:text-blue-700 pr-0">
            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
              width="24" height="24" fill="none" viewBox="0 0 24 24">
              <path stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M13.213 9.787a3.391 3.391 0 0 0-4.795 0l-3.425 3.426a3.39 3.39 0 0 0 4.795 4.794l.321-.304m-.321-4.49a3.39 3.39 0 0 0 4.795 0l3.424-3.426a3.39 3.39 0 0 0-4.794-4.795l-1.028.961" />
